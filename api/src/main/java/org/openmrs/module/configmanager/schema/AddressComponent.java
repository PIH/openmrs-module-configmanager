...
public class AddressComponent {
    ...
    public AddressComponent(String uuid, AddressField field, String nameMapping, int sizeMapping, String elementDefault, boolean requiredInHierarchy) {
        this.uuid = uuid;
        this.field = field;
    ...
    public int hashCode() {
        int ret = 17;
        ret = 31 * ret + (uuid == null ? 0 : uuid.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        boolean ret = true;
        ret = ret && OpenmrsUtil.nullSafeEquals(this.getUuid(), that.getUuid());
